...
namespace MISA.QLTSv2.DL
{
    ...
    public class RefDecrementDL
    {
        ...
        /// </summary>
        /// <returns>list ghi giảm</returns>
        /// Author: DVVUONG (10/03/2021)
        public List<RefDecrement> GetRefDecrements()
        {
            // Thực thi commandText:
            var refDecrements = _dbConnection.Query<ref_decrement>($"Proc_SelectRefDecrementDatas", null, commandType: CommandType.StoredProcedure);

            // Trả về dữ liệu:
            return _mapper.Map<List<RefDecrement>>(refDecrements);
        }


        /// <summary>
        /// Lấy bản ghi ghi giảm theo khóa chính
        /// </summary>
        ...
        /// <summary>
        /// Thêm mới phiếu ghi giảm
        /// </summary>
        /// <param name="entity">object ghi giảm</param>
        ...
        /// <summary>
        /// Sửa bản ghi ghi giảm
        /// </summary>
        /// <param name="entity"></param>
        /// <returns>SỐ lương bản ghi thay đổi</returns>
        /// createdBy:DVUONG(10/03/2021)
        public int UpdateRefDecrement(RefDecrement refDecrement)
        {
            // Build thành đối tượng để lưu vào database:
            var parameters = MappingDbType(refDecrement);
